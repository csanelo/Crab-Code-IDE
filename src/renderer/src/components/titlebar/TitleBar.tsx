...
import { ArrowUpRight, Minus, Square, Copy, X, Settings } from "lucide-react";
        ...
        {!agentWindow && (
          <>
            ...
            >
              ...
              <ArrowUpRight className="titlebar__agent-arrow" size={12} strokeWidth={1.8} />
            </button>
            <button
              ...
              data-tip="Internal browser — the agent's eyes"
        ...
        {!agentWindow && (
          <>
            <button
              ...
              data-tip={t("nav.openTerminalHint")}
              onClick={onToggleTerminal}
            >
